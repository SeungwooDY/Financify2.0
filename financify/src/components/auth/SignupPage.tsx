...
import { Eye, EyeOff, Lock, User, Mail, ArrowRight, Sparkles, ArrowLeft } from "lucide-react"
...
export function SignupPage({ onSignup, onBackToLogin, isLoading = false, error }: SignupPageProps) {
      ...
      <div className="relative z-10 w-full max-w-[2000px]">
        ...
        <Card className="card-elevated animate-fade-in-up max-w-8xl mx-auto">
          <CardHeader className="text-center pb-4">
            <CardTitle className="text-4xl font-semibold">Get started</CardTitle>
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Email field */}
              <div className="space-y-2">
                <label htmlFor="email" className="text-lg font-medium text-text-secondary">
                  Email (optional)
                </label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <label htmlFor="confirmPassword" className="text-lg font-medium text-text-secondary">
                  Confirm Password
                </label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-muted-foreground" />
