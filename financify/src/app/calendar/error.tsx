    ...
    <div className="container-5xl py-8">
      <Card className="card-standard">
        <CardContent className="p-12 text-center">
          ...
          <Heading as="h1" size="2xl" className="mb-2">Error Loading Calendar</Heading>
          <Text color="muted" className="mb-6">
            We couldn&apos;t load your calendar data. This might be due to a network issue or server problem.
          </Text>
